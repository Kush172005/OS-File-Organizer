...
function App() {
  ...
  const handleOrganize = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/organize', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {files.length === 0 && !isLoading && (
          <div className="text-center py-16 mt-6">
            ...
            <p className="text-xs text-gray-500 mb-6">Select a folder to get started</p>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
              ...
              <span className="text-xs font-medium text-gray-600">Built by Team Mavericks</span>
            </div>
          </div>
        )}
      </div>
